...
extension UIView {
    ...
    class func registerFooterHeader(for tableView:UITableView) {
        let reuseId =  String(describing:self)
        let nib = UINib(nibName: reuseId, bundle: Bundle(for: self))
        tableView.register(nib, forHeaderFooterViewReuseIdentifier: reuseId)
    }
    
    class func dequeFooterHeader<T: UIView>(from tableView:UITableView) -> T {
        let reuseId =  String(describing:self)
        guard
...
extension UICollectionViewCell {
    ...
    class func deque<T: UICollectionViewCell>(from collectionView:UICollectionView, for indexPath: IndexPath) -> T {
        let reuseId =  String(describing:self)
